...
def checkCountryHistoricalRatings(country):
    ...
    if type(country) is str:
        ...
        linkAPI += quote(",".join([c.lower() for c in country]), safe="")
    return linkAPI
...
def getHistoricalData(
    country=None, indicator=None, initDate=None, endDate=None, output_type=None
):
    """
...
def getHistoricalRatings(
    country=None, rating=None, initDate=None, endDate=None, output_type=None
):
    """
...
def getHistoricalByTicker(
    ticker=None, start_date=None, end_date=None, output_type=None
):
    """
